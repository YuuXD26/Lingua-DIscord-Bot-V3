            ...
            if (premium) {
                ...
                message.reply({
                    embeds: [new MessageEmbed()
                        ...
                        .setDescription(`<:success:1160601683798270042> You have Successfully Redeemed Premium!
Expires at: ${expires}`)
                        .setColor(ee.color)
                    ]
                });
...
If you buyed and the code is not working contact **[Lingua](${process.env.SUPPORT})**`)
                        .setColor(ee.wrongcolor)
                    ]
                });
