            ...
            Schema.findOneAndDelete({
                ...
                if (!data) return message.reply({
                    embeds: [new MessageEmbed()
                        ...
                        .setDescription(`<:cancel:1160601546816503848> AntiLink is Already **Disabled** in this server!`)
                    ]
                })
                ...
                message.reply({
                    embeds: [new MessageEmbed()
                        ...
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setDescription(`<:success:1160601683798270042> **AntiLink** is now Disabled!`)
                    ]
                });
            })
