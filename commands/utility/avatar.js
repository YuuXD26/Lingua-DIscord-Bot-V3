  ...
  async execute(client, message, args, ee) {
    try {
      ...
      message.reply({ embeds:[new MessageEmbed()
        ...
        .addField("<:plus:1160606274002616451> PNG",`[\`LINK\`](${member.displayAvatarURL({format: "png"})})`, true)
        .addField("<:plus:1160606274002616451> JPEG",`[\`LINK\`](${member.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<:plus:1160606274002616451> WEBP",`[\`LINK\`](${member.displayAvatarURL({format: "webp"})})`, true)
        .setColor(ee.color)
