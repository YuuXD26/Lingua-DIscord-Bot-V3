...
const owners = [ "981655069399351398" ];
                ...
                try {
                    ...
                    if (command.premium && premiumServer && !premiumServer.isPremium) {
                        return message.reply({
                            embeds: [new MessageEmbed()
                                ...
                                Join **[Anxious](${process.env.SUPPORT})** And **Open a Ticket!**`)
                                .setColor(ee.wrongcolor)
                            ]
                        })
                    }
                    ...
                    commandLogsChannel.send({
                        embeds: [new MessageEmbed()
                            ...
                            .setTitle(`<:plus:1160606274002616451> Prefix Command`)
                            .addField("**<:plus:1160606274002616451> Author**", `\`\`\`${message.author.tag}\`\`\``)
                            .addField("**<:plus:1160606274002616451> Command Name**", `\`\`\`${command.name}\`\`\``)
                        ]
                    });
                } catch (error) {
                    console.log(error)
