    ...
    client.on("interactionCreate", async (interaction) => {
        try {
            ...
            if (interaction.isButton()) {
                if (!["music-skip", "music-pause", "music-resume", "music-stop", "music-autoplay", "music-loop", "music-queue", "music-volume-plus"].includes(interaction.customId)) return;
                            ...
                            return interaction.reply({
                                embeds: [new MessageEmbed()
                                    ...
                                    .setDescription(`This server is not a premium server!
                                        ...
                                        Join **[FLAMES](${process.env.SUPPORT})** And **Open a Ticket!**`)
                                    .setColor(ee.wrongcolor)
                                ],
                                ephemeral: true
                            })
